...
License / Lizenz
EN: * Dockerfile: Licensed under the MIT License.

Kernel Content: The resulting image and downloaded sources contain the Linux Kernel, which is licensed under GPL-2.0.

Copyright: (c) 2026 Polygon Data UG

DE: * Dockerfile: Lizenziert unter der MIT-Lizenz.

Kernel-Inhalt: Das resultierende Image und die heruntergeladenen Quellen enthalten den Linux-Kernel, welcher unter der GPL-2.0 lizenziert ist.
